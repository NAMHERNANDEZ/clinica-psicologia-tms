...
const BASE_CONNECTOME: ConnectomeConfig = {
  regions: ['dlpfc_l', 'dlpfc_r', 'm1_l', 'm1_r', 'sma', 'acc', 'insula_l', 'insula_r', 'broca', 'wernicke'],
  matrix: [
    // dlpfc_l  dlpfc_r  m1_l     m1_r     sma      acc      insula_l insula_r broca    wernicke
    [0.00,     0.65,    0.40,    0.10,    0.35,    0.70,    0.55,    0.10,    0.05,    0.05],  // dlpfc_l
    [0.65,     0.00,    0.10,    0.40,    0.35,    0.70,    0.10,    0.55,    0.05,    0.05],  // dlpfc_r
    [0.40,     0.10,    0.00,    0.30,    0.60,    0.15,    0.10,    0.05,    0.05,    0.05],  // m1_l
    [0.10,     0.40,    0.30,    0.00,    0.60,    0.15,    0.05,    0.10,    0.05,    0.05],  // m1_r
    [0.35,     0.35,    0.60,    0.60,    0.00,    0.30,    0.10,    0.10,    0.10,    0.10],  // sma
    [0.70,     0.70,    0.15,    0.15,    0.30,    0.00,    0.60,    0.60,    0.10,    0.10],  // acc
    [0.55,     0.10,    0.10,    0.05,    0.10,    0.60,    0.00,    0.40,    0.20,    0.10],  // insula_l
    [0.10,     0.55,    0.05,    0.10,    0.10,    0.60,    0.40,    0.00,    0.10,    0.20],  // insula_r
    [0.05,     0.05,    0.05,    0.05,    0.10,    0.10,    0.20,    0.10,    0.00,    0.50],  // broca
    [0.05,     0.05,    0.05,    0.05,    0.10,    0.10,    0.10,    0.20,    0.50,    0.00],  // wernicke
  ],
};
