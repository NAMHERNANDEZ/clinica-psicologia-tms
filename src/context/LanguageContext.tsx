...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'services.ptsd': 'TEPT',
    'services.ptsdDesc': 'Tratamiento para trastorno de estrés postraumático con EMDR, terapia cognitiva y EMT/TMS para casos resistentes.',
    'services.ocd': 'TOC',
  ...
  en: {
    ...
    'services.ptsd': 'PTSD',
    'services.ptsdDesc': 'Treatment for post-traumatic stress disorder with EMDR, cognitive therapy and TMS for resistant cases.',
    'services.ocd': 'OCD',
